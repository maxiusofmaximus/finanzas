    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                <form method="POST" action="{{ route('gastos.store') }}" class="mx-auto">
                    @csrf

                        <div class="columns-4">
                            <div class="w-full">
                                <label for="monto" class="px-8 py-2 text-gray-900 dark:text-white text-center">Gasto</label>
                    ...
                    <a href="{{ route('gastos.index') }}" class="text-white bg-slate-700 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-slate-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-slate-600 dark:hover:bg-slate-700 dark:focus:ring-slate-800">Cancel</a>
                </form>
            </div>
        </div>
    </div>
